						...
						<%@include file="includes/navbar.jsp"%>
							<div class="no_margin">
								<div class="row justify-content-md-end cover_all no_margin">
											...
											<div class="board col-md-auto">
												<div id="initial_location" class="myGrid ${randomGrid.difficulty}">
													<c:forEach items="${randomGrid.nameImages}" var="piece">
														<span class="box_piece" ondrop="drop(event)" ondragover="allowDrop(event)"><img draggable="true" ondragstart="drag(event)" id="${piece}" class="piece" src="resources/images/${randomGrid.subjectName}/${randomGrid.difficulty}/${piece }.png "/></span>
													</c:forEach>
												</div>
											</div>
									...
									<div class="row col-12 col-md-2 col-sm-12 col-xs-12 game_info pr-0"></div>
								</div>
							</div>
						</body>
					</html>
