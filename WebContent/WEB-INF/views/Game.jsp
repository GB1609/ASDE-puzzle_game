...
<body class="wsmenucontainer">
	...
	<div class="no_margin">
		<div class="row justify-content-md-end cover_all no_margin">
			<div id="view"
						...
						<div id="initial_location" class="myGrid ${randomGrid.difficulty}">
							<c:forEach items="${randomGrid.nameImages}" var="piece">
								<span class="box_piece" ondrop="drop(event)"
									...
									src="resources/images/puzzles/${randomGrid.subjectName}/${randomGrid.difficulty}/${piece}.png" />
								</span>
							</c:forEach>
						</div>
					</div>
				...
				<div class="row justify-content-center col-md-12">
					<div class="row card-with-shadow">
						<div class="col">
							<button id="show-image-button" type="button"
								class="btn btn-warning btn-lg button-in-row"
								onclick="allowHint()" data-target="#show-modal">Show
								Image</button>
							<div class="modal fade " id="show-modal">
								<div class="modal-dialog">
									<div class="modal-content card-with-shadow">
										...
										<div class="modal-header">
											<img alt="imageToCompose"
												src="resources/images/puzzles/${randomGrid.subjectName}/${randomGrid.subjectName}.jpg"
			...
			<div
				class="row minimal-row col-12 col-md-3 col-sm-12 col-xs-12 game_info card-with-shadow">
				<div class="row minimal-row fit-row">
					<label for="progress_name_text" style="color: white;">Opponent's
						progress </label>
					<div id="dynamic">
						<!-- PROGRESS BAR -->
					</div>
					<div class="row">
						<!-- CHAT -->
						<div class="chat">
							<div class="row chat-list scrollbar-ripe-malinka"
								id="chat_content"></div>
							<div class="row input-chat ">
								<input type="text" class="form-control col-9 card-with-shadow"
									id="message_text" placeholder="Message to send">
								<button type="button" onclick="sendMessage()"
									class="btn btn-warning button-send btn-sm col-2">
									<img src="resources/images/icons/send.png" class="piece"
