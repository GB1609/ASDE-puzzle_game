...
<body class="wsmenucontainer">
	...
	<div align="center">
			...
			<div class="dropdown col-sm-6 row">
				...
				<div class="dropdown col">
					<button type="button"
						...
						aria-haspopup="true" data-toggle="dropdown">Search Lobby</button>
		...
		<div class="row center-content-row">
			...
			<div class="row col-1">
				<button type="submit" onclick="changeTypeList()"
					class="btn btn-warning btn-sm col" style="margin-right: 0.5rem">change</button>
			</div>
		</div>
	</div>
</body>
