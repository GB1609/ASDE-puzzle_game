								...
								<div id="lobbies_div" class="col-sm-6">
									...
									<c:if test="${not empty lobbies}">
										...
										<div class="dropdown col-sm-6">
											<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Create Lobby</button>
											<div class="dropdown-menu">
												<form action="create_lobby">
													<div class="form-group">
														<label for="lobby_name_text">Lobby's name:</label>
														<input type="text" class="form-control" id="id_lobby_name" name="lobby_name"></div>
												...
												<form action="search_lobby_by_name">
													...
													<form action="search_lobby_by_username">
														<div class="form-group row">
															<input type="text" class="form-control" id="id_user_name" name="user_name" placeholder="Username">
