				...
				<div align="center">
					<div class="row center-content-row">
						<div class="dropdown col-sm-6 row">
							<div class="col">
								<button type="button" class="btn btn-warning btn-lg button-in-row" onclick="refreshLobbies()">Refresh</button>
							</div>
										...
										<form id="id_create_lobby_form">
											<div class="modal-header center-content-row">
												<div class="form-group">
													<label for="lobby_name_text" style="color: white;">Lobby's name:
													</label>
							...
							<div class="dropdown col">
								<button type="button" class="btn btn-warning btn-lg dropdown-toggle button-in-row" data-toggle="dropdown">Search Lobby</button>
