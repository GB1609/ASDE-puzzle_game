<li class="list-group-item card-with-shadow lobby_row"
	style="display: none;" id="template">
	<div class="text-center" id="lobby_name_div"></div>
	<div id="id_lobby_div" class=" text-center">
		<img id="id_img_owner" src="" class="img-circle" height="64"
			width="64" alt="Avatar"> <span id="id_owner_name"></span> <img
			style="max-height: 1cm; max-width: 1cm; margin-left: 0%;"
			src="resources/images/icons/vs.png"> <span id="id_guest_name"></span>
		<img id="id_img_guest" src="" class="img-circle" height="64"
			width="64" alt="Avatar">
