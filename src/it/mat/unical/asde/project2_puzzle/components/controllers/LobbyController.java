...
public class LobbyController{
    ...
    public String createLobby(HttpSession session,@RequestParam String lobby_name){
        String username = (String) session.getAttribute("username");
        return this.initJSOONResponse(username).put("error", !this.lobbyService.addLobby(new Lobby(lobby_name, username))).toString();
    }
    ...
    public String deleteLobbyByName(HttpSession session,@RequestParam String lobby_name){
        return this.initJSOONResponse((String) session.getAttribute("username")).put("error", !this.lobbyService.removeLobbyByName(lobby_name))
                .toString();
    }
