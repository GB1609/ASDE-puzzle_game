...
//	}
    ...
    public String joinLobby(HttpSession session,@RequestParam String lobby_name){
        ...
        System.out.println("User: " + username + " join to Lobby: " + this.lobbyService.getLobby(lobby_name, SearchBy.LOBBY_NAME));
        return result.toString();
    }
    ...
    public String searchLobby(HttpSession session,@RequestParam String search_txt,@RequestParam String search_by){
        ...
        return result.put("error", true).put("err_msg", "Lobby with " + search_by + ": " + search_txt + " not found").toString();
    }
